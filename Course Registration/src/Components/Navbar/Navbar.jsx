  ...
  return (
    <div>
      <nav className="navbar navbar-expand-lg navbar-gradient fixed-top NavBar " >
        <div className="container-fluid fluidContainer">
<div className='brandBox'>
  <img className="logoImg" src={logo} alt="logo" width="100" height="100"></img>
          <p className="navbar-brand">ACE ACADEMY</p>
          <p className='tagline'>Empowering you to writeyour  success story.</p>
          </div>
          ...
          <div className="btn-group">
            {/* login / Register */}
  <button type="button" className="btn btn-primary dropdown-toggle buttons" data-bs-toggle="dropdown" aria-expanded="false">
    Login/Register
  </button>
  <ul className="dropdown-menu loginMenu">
  ...
  {/* logout */}
  <Link to={'/logout'} type="button" className="btn btn-primary buttons ">Log Out</Link>
</div>
        </div>
      </nav>
    </div>
